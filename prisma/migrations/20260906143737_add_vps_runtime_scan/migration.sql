...
-- CreateTable
CREATE TABLE "VPSRuntimeScan" (
    "id" TEXT NOT NULL,
    "vpsId" TEXT NOT NULL,
    "deploymentId" TEXT,
    "scanResult" TEXT NOT NULL,
    "installLogs" TEXT NOT NULL DEFAULT '[]',
    "ready" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "VPSRuntimeScan_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "VPSRuntimeScan_vpsId_idx" ON "VPSRuntimeScan"("vpsId");

-- CreateIndex
CREATE INDEX "VPSRuntimeScan_vpsId_createdAt_idx" ON "VPSRuntimeScan"("vpsId", "createdAt");

-- CreateIndex
CREATE INDEX "VPSRuntimeScan_deploymentId_idx" ON "VPSRuntimeScan"("deploymentId");
...
-- AddForeignKey
ALTER TABLE "VPSRuntimeScan" ADD CONSTRAINT "VPSRuntimeScan_vpsId_fkey" FOREIGN KEY ("vpsId") REFERENCES "VPS"("id") ON DELETE CASCADE ON UPDATE CASCADE;
